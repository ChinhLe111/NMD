...
<Meta title="Getting Started/With Angular" />
...
<div class="link-list">
  ...
  >
    ...
    <span>
      ...
      Design was built by the incredible <strong>Author</strong>
    </span>
  </a>
</div>
...
<div class="link-list">
  <a class="link-item link-item--title-only" href="https://twitter.com" target="_blank">
    <img src={Twitter} alt="code" />
    <strong>Twitter</strong>
  </a>
  <a class="link-item link-item--title-only" href="https://github.com" target="_blank">
